...
set_slave_stmt='change master to master_host='$master_container', master_user='$cluster_user', master_password='$cluster_password', master_port=3306, master_log_file='$log_name', master_log_pos=$log_pos;'
